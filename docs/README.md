---
description: Bạn là người mới tìm hiểu COKA? Bạn có thể bắt đầu tại đây.
---
...
<div data-full-width="false"><figure><img src=".gitbook/assets/thumblail.png" alt=""><figcaption></figcaption></figure></div>

## Tải, cài đặt và bắt đầu cùng COKA

{% content-ref url="tai-cai-dat-va-bat-dau-cung-coka.md" %}
...
<table data-card-size="large" data-view="cards" data-full-width="false"><thead><tr><th align="center"></th><th data-card-target data-type="content-ref"></th><th data-hidden data-card-cover data-type="files"></th></tr></thead><tbody><tr><td align="center"><strong>Bước 3</strong>         </td><td><a href="vai-tro-thanh-vien/buoc-3-cham-soc-theo-doi-va-quan-ly-khach-hang-voi-coka.md">buoc-3-cham-soc-theo-doi-va-quan-ly-khach-hang-voi-coka.md</a></td><td><a href=".gitbook/assets/step3-user (1).jpg">step3-user (1).jpg</a></td></tr><tr><td align="center"><strong>Bước 4</strong> </td><td><a href="vai-tro-thanh-vien/buoc-4-kham-pha-san-pham-va-nhu-cau-cua-khach-hang.md">buoc-4-kham-pha-san-pham-va-nhu-cau-cua-khach-hang.md</a></td><td><a href=".gitbook/assets/step4 user.jpg">step4 user.jpg</a></td></tr></tbody></table>
...
<table data-card-size="large" data-view="cards"><thead><tr><th></th><th data-hidden data-card-target data-type="content-ref"></th><th data-hidden data-card-cover data-type="files"></th></tr></thead><tbody><tr><td><p><strong>Chat đa kênh</strong></p><p>Chat đa kênh cho phép trò chuyện từ nhiều nền tảng như Zalo, Facebook Messenger, Email, và In - app chat.</p></td><td><a href="tien-ich-cua-coka/chat-da-kenh.md">chat-da-kenh.md</a></td><td><a href=".gitbook/assets/multiple chat.png">multiple chat.png</a></td></tr><tr><td><p><strong>Giỏ hàng</strong></p><p>Giỏ hàng là tính năng cho phép gom nhiều sản phẩm vào một giỏ để quản lý tập trung và phân bổ đều đến cái không gian làm việc.</p></td><td><a href="tien-ich-cua-coka/gio-hang.md">gio-hang.md</a></td><td><a href=".gitbook/assets/shoppingcart.png">shoppingcart.png</a></td></tr><tr><td><p><strong>Giao dịch</strong></p><p>Giao dịch là nơi các trạng thái nhu cầu của sản phẩm sẽ được tập trung ở đây. Giúp quản trị viên có thể theo dõi cũng như phê duyệt các giao dịch dễ dàng hơn.</p></td><td><a href="tien-ich-cua-coka/giao-dich.md">giao-dich.md</a></td><td><a href=".gitbook/assets/transcation.png">transcation.png</a></td></tr><tr><td><p><strong>Báo cáo</strong></p><p>Báo cáo là tính năng tổng hợp và phân tích dữ liệu từ không gian làm việc, thành viên, sản phẩm, giỏ hàng, và doanh thu bên trong tổ chức.</p></td><td><a href="tien-ich-cua-coka/bao-cao.md">bao-cao.md</a></td><td><a href=".gitbook/assets/reporrt.png">reporrt.png</a></td></tr></tbody></table>
